...
CNeedle::CNeedle(Mesh* _modelMesh)
...
void CNeedle::SetLength(const float m_fLength)
{
    this->m_fLength = m_fLength;
}

// Get the length of the laser
float CNeedle::GetLength(void) const
{
    return m_fLength;
}

// Update this laser
void CNeedle::CalculateAngles(void)
{
...
CNeedle* Create::Needle(const std::string& _meshName,
    ...
    CPlayerInfo* _source)
{
    ...
    CNeedle* result = new CNeedle(modelMesh);
